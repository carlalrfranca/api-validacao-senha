...
@AllArgsConstructor
@Getter
public enum MensagemSenha {
    CONTEM_TAMANHO_MINIMO("TamanhoMinimo","A senha deve conter no mínimo 9 caracteres."),
    ...
    public static String extraiRegra(String nomeRegra) {
        MensagemSenha[] regras = values();
        int indice = 0;

        while (indice < regras.length) {
            MensagemSenha regra = regras[indice];
